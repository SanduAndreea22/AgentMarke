# Facebook — Vânzarea de bilete/locuri gestionată manual la evenimente
...
FB — Seara dinainte de eveniment, verificat manual cine a plătit

## Postare

Cel mai stresant moment la un eveniment nu e ziua evenimentului. E seara dinainte, când verifici manual cine a plătit și cine doar a promis.
...
Voi cum gestionați acum biletele sau locurile la un eveniment — listă pe hârtie, mesaje salvate, sau ceva care chiar ține evidența pentru voi?

## Hashtag-uri

#Antreprenoriat #Evenimente #DigitalizareAfaceri #BusinessLocal

## Idee de imagine

Split-screen: stânga — un caiet cu nume bifate de mână și o grămadă de capturi de ecran WhatsApp cu „am plătit, uite dovada". Dreapta — un telefon afișând un bilet digital cu cod QR, scanat la intrare cu un check verde instant.
...
```
FACTUAL_ACCURACY: PASS (Platform Tickets — proiect real din products_services.md, funcționalități confirmate: Stripe, QR, PDF)
BRAND_VOICE: 5/5
...
Lungime: ~215 cuvinte (în intervalul curent 150-300).
